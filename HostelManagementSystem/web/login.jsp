...
<div class="container">
    ...
    <%
        ...
        String dbURL = "jdbc:derby://localhost:1527/HostelDB"; // adjust based on your setup
        String dbUser = "Manasha"; // update with your DB username
        String dbPass = "2005";  // update with your DB password
